/* =========================================================
   AuthProvider — sessão do Supabase disponível pro app todo

   Mesma conta do Foco: é o mesmo projeto Supabase, então o
   login é o mesmo e os dois apps enxergam o mesmo usuário.
   ========================================================= */
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    // mantém a sessão em dia se ela expirar ou se você sair em outra aba
...
export function traduzirErro(err: unknown): string {
  ...
  return err instanceof Error ? err.message : 'Não consegui completar. Tente de novo.'
}
